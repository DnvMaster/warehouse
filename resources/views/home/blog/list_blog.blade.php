                    ...
                    @foreach($blog_post as $post)
                        <div class="lonyo-blog-wrap" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div class="lonyo-blog-meta">
                                <ul>
                                    <li><a href="single-blog.html"><img src="{{ asset('frontend/images/blog/date.svg') }}" alt="{{ __('Data') }}">{{ $post->created_at->format('M d Y') }}</a></li>
                                    <li><a href="single-blog.html"><img src="{{ asset('frontend/images/blog/clock.svg') }}" alt="{{ __('Время') }}">{{ __('5 min read') }}</a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <a class="lonyo-blog-recent-post-item" href="single-blog.html">
                        <div class="lonyo-blog-recent-post-thumb">
                            <img src="{{ asset('frontend/images/blog/b6.png') }}" alt="">
                        </div>
                        <div class="lonyo-blog-recent-post-data">
                            <ul>
                                <li><img src="{{ asset('frontend/images/blog/date.svg') }}" alt="">June 08, 2025</li>
                            </ul>
                            <div>
