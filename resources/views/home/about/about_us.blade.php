...
@section('home')
    ...
    <div class="container">
      ...
      <div class="breadcrumb-content">
        <h1 class="breadcrumb-title pb-0">{{ __('О нас') }}</h1>
        <div class="breadcrumb-menu-wrapper">
          <div class="breadcrumb-menu-wrap">
            <div class="breadcrumb-menu">
              <ul>
                <li><a href="{{ url('/') }}">{{ __('Главная') }}</a></li>
                <li><img src="{{ asset('frontend/images/blog/right-arrow.svg') }}" alt="{{ __('О нас')}}"></li>
                <li aria-current="page">{{ __('О нас') }}</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="lonyo-about-us-thumb2 pr-51" data-aos="fade-up" data-aos-duration="700">
            <img src="{{ asset('frontend/images/about-us/img7.png') }}" alt="">
          </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="lonyo-team-wrap" data-aos="fade-up" data-aos-duration="500">
                    <div class="lonyo-team-thumb">
                        <a href="#"><img src="{{ asset($team->image) }}" alt="{{ $team->name }}"></a>
                    </div>
