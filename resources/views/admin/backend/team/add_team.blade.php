    ...
    <div class="container-xxl">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">{{ __('Добавление клиента') }}</h4>
            </div>
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="{{ route('add.team') }}">{{ __('Добавить') }}</a></li>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h4 class="card-title text-center mb-0">{{ __('Информация о клиенте') }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="{{ route('store.team') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    <img class="rounded-circle avatar-xxl img-thumbnail float-start" id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="Image Client">
                                                </div>
                                            </div>
